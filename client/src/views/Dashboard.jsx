  ...
  return (
    <div className="container">
      ...
      <div className="row g-5">
        <div className="col total-gross board">
        ...
        <div className="col total-sold board">
          <div className="dashboard-title">
        ...
        <div className="col sales-pro board">
          <div className="dashboard-title">
        ...
        <div className="col outreach board">
          <div className="dashboard-title">
        ...
        <div className="row g-5">
          ...
          <div className="col fixed-operations board">
            <div className="dashboard-title">
          ...
          <div className="col sales-fin-managers board">
            <div className="dashboard-title">
          ...
          <div className="col service-parts-managers board">
            <div className="dashboard-title">
